...
void CFluidIteration::Iterate(COutput *output,
                                 ...
                                 unsigned short val_iZone,
                                 unsigned short val_iInst) {
  unsigned long IntIter, ExtIter, nGlobal_Vertex_Poin;
  ...
  // nGlobal_Vertex_Poin = output->GetnGlobal_Surf_Poin();
  nGlobal_Vertex_Poin = 1000;
  ...
  integration_container[val_iZone][val_iInst][FLOW_SOL]->MultiGrid_Iteration(geometry_container, solver_container, numerics_container,
                                                                  config_container, RUNTIME_FLOW_SYS, IntIter, val_iZone, val_iInst, nGlobal_Vertex_Poin);
