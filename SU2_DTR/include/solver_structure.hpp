...
public:
   ...
   * \param[in] val_iterlinsolver - Number of linear iterations.
   */
  void SetResidual_RMS(CGeometry *geometry, CConfig *config, bool kind_resEval, unsigned long Surf_Poin);
   ...
   * \param[in] config - Definition of the particular problem.
   */
  vector<vector<double> > SetSolution_GradientMagn_Exact_LS(CGeometry *geometry, CConfig *config, vector<vector<double> > sol_exact);
   ...
   * \param[in] config - Definition of the particular problem.
   */
  virtual void Set_MPI_SolutionExact_Gradient(CGeometry *geometry, CConfig *config, su2double ***Grad_Exact);
 ...
 /*!
   ...
   * \param[in] config - Definition of the particular problem.
   */
  virtual void No_Iteration(CGeometry *geometry, CSolver **solver_container, CConfig *config, unsigned long Surf_Poin = 0);
   ...
   * \param[in] ExtIter - External iteration.
   */
  virtual void SetInitialDualTime(CGeometry **geometry,
                                   CSolver ***solver_container,
                                   CConfig *config, unsigned long ExtIter);
  ...
  virtual void LoadExactRestart(CGeometry **geometry, CSolver ***solver,
                           CConfig *config, int val_iter, bool val_update_geo);
...
public:
   ...
   * \param[in] config - Definition of the particular problem.
   */
  void Set_MPI_SolutionExact_Gradient(CGeometry *geometry, CConfig *config, su2double ***Grad_Exact);
  ...
  */
   ...
   * \param[in] config - Definition of the particular problem.
   */
  void No_Iteration(CGeometry *geometry, CSolver **solver_container, CConfig *config, unsigned long Surf_Poin = 0);
  ...
  */
  ...
  /*!
   * \brief Load a CFD solution from a restart file.
   * \param[in] geometry - Geometrical definition of the problem.
   * \param[in] solver - Container vector with all of the solvers.
   * \param[in] config - Definition of the particular problem.
   * \param[in] val_iter - Current external iteration number.
   * \param[in] val_update_geo - Flag for updating coords and grid velocity.
   */
  void LoadExactRestart(CGeometry **geometry, CSolver ***solver, CConfig *config, int val_iter, bool val_update_geo);
   ...
   * \param[in] val_update_geo - Flag for updating coords and grid velocity.
   */
  vector<vector<double> > LoadExactSolution(CGeometry **geometry, CConfig *config, int val_iter, bool val_update_geo);
   ...
   * \param[in] ExtIter - External iteration.
   */
  void SetInitialDualTime(CGeometry **geometry, CSolver ***solver_container, CConfig *config, unsigned long ExtIter);
