...
public:
   ...
   * \brief Perform some pre-processing before an iteration of the physics.
   */
  void PreprocessExtIterDT(unsigned long ExtIter);
...
public:
  ...
  /*!
   * \brief PreprocessDT the single-zone iteration
   */
  void PreprocessDT(unsigned long TimeIter);
