...
inline void CSolver::Set_MPI_SolutionExact_Gradient(CGeometry *geometry, CConfig *config, su2double ***Grad_Exact) { }
...
inline void CSolver::SetInitialDualTime(CGeometry **geometry, CSolver ***solver_container, CConfig *config, unsigned long ExtIter) { }
...
inline void CSolver::LoadExactRestart(CGeometry **geometry, CSolver ***solver, CConfig *config, int val_iter, bool val_update_geo) { }
...
inline void CSolver::No_Iteration(CGeometry *geometry, CSolver **solver_container, CConfig *config, unsigned long Surf_Poin) { }
