...
private:
  ...
  *Marker_CfgFile_KindBC;		/*!< \brief Global index for boundaries using config file. */
  ...
  unsigned short nCoordsBox;			/*!< \brief Number of coords to define box. */
  su2double *RK_Alpha_Step;			/*!< \brief Runge-Kutta beta coefficients. */
  su2double *Coords;			/*!< \brief Coords for the box residual evaluation. */
  ...
  *Kappa_Heat;                    /*!< \brief Numerical dissipation coefficients for the (fvm) heat equation. */  
  ...
  Surf_ResEval, /*!< \brief Compute residuals on solid walls only. */
  Error_Direct; /*!< \brief Compute residuals on solid walls only. */
...
public:
   ...
   * \return Alpha coefficient for the Runge-Kutta integration scheme.
   */
  su2double Get_Box_Coords(unsigned short val_step);
  ...
  /*!
   * \brief Flag for whether computing residuals all over the domain or just on solid walls.
   * \return Flag for whether computing residuals all over the domain or just on solid walls, if <code>TRUE</code> then compute residuals only on solid walls.
   */
  bool GetSurf_ResEval(void);

  /*!
   * \brief Flag for whether computing direct error.
   * \return Flag for whether computing direct error.
   */
  bool GetError_Direct(void);
  /*!
   ...
   * \return Name of the file with the solution of the flow problem.
   */
  string GetExact_FlowFileName(void);
