...
void CConfig::SetConfig_Options(unsigned short val_iZone, unsigned short val_nZone) {
  ...
  /*!\brief Residual Evaluation on solid walls \n Options: YES, NO \ingroup Config */
  addBoolOption("SURF_RESEVAL", Surf_ResEval, true);
  /*!\brief Direct error \n Options: YES, NO \ingroup Config */
  addBoolOption("DIRECT_ERROR", Error_Direct, true);
 ...
 /* DESCRIPTION: default value for AIR */
  ...
  addDoubleListOption("RK_ALPHA_COEFF", nRKStep, RK_Alpha_Step);
    // these options share nRKStep as their size, which is not a good idea in general
  /* DESCRIPTION: Runge-Kutta alpha coefficients */
  addDoubleListOption("BOX_COORDS", nCoordsBox, Coords);
  ...
  * objective.  \ingroup Config   */
  ...
  /*!\brief EXACT_FLOW_FILENAME \n DESCRIPTION: Restart flow input file (the file output under the filename set by RESTART_FLOW_FILENAME) \n DEFAULT: solution_flow.dat \ingroup Config */
  addStringOption("EXACT_FLOW_FILENAME", Exact_FlowFileName, string("restart_flow.dat"));
...
void CConfig::SetPostprocessing(unsigned short val_software, unsigned short val_izone, unsigned short val_nDim) {
 ...
 { Wrt_Unsteady = false; }
  ...
  if (nRKStep == 0) {
    ...
    if (nCoordsBox == 0) {
    nCoordsBox = 2;
    Coords = new su2double[nCoordsBox]; Coords[0] = 0.0; Coords[1] = 0.0;
  }
  ...
  if (((Kind_SU2 == SU2_CFD) || (Kind_SU2 == SU2_DTR)) && (Kind_Solver == NO_SOLVER)) {
...
void CConfig::SetOutput(unsigned short val_software, unsigned short val_izone) {
  ...
  switch (val_software) {
    ...
    case SU2_DTR: cout << "|   |___/\\___//___|   Suite (Residual Evaluation Code)                  |" << endl; break;
  }
    ...
    if ((Kind_Solver == EULER) || (Kind_Solver == NAVIER_STOKES) || (Kind_Solver == RANS) ||
      ...
      switch (Kind_TimeIntScheme_Flow) {
        ...
        case CLASSICAL_RK4_EXPLICIT:
          ...
          break;
        case NO_T_INTEGRATION:
          cout << "Residual time evaluation for dual time stepping" << endl;
      }
    }
